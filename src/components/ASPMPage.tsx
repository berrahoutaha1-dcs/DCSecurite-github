...
const ASPMPage: React.FC<ASPMPageProps> = (props) => {
    ...
    <div className="min-h-screen bg-[#0a0e27] text-white transition-colors duration-300">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 sm:px-8 md:px-12 max-w-7xl mx-auto">
          ...
          <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-8 bg-gradient-to-r from-gray-900 via-cyan-600 to-gray-900 dark:from-white dark:via-cyan-200 dark:to-white bg-clip-text text-transparent tracking-tight"
          ...
          <motion.p
            className="text-xl sm:text-2xl md:text-3xl text-gray-600 dark:text-cyan-100/80 mb-12 max-w-4xl mx-auto"
            style={{ fontWeight: 300 }}
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, delay: 0.3, ease: "easeOut" }}
          >
            Continuous analysis. Zero blind spots. Intelligent protection for every application.
          </motion.p>

          <motion.button
            className="group relative px-12 py-5 rounded-full bg-transparent border-2 border-cyan-500 dark:border-cyan-400 text-cyan-700 dark:text-cyan-300 text-lg overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            >
              ...
              >
                Application Security Posture Management provides a unified view of your application
                security across the entire development lifecycle. It correlates findings from
                multiple security tools, prioritizes risks based on business context, and provides
                actionable insights to remediate vulnerabilities before they reach production.
              </p>

              {/* Vertical Timeline */}
              <div className="space-y-6 mt-12">
                {[
                  { icon: Search, text: "Discover all applications and dependencies" },
                  { icon: Eye, text: "Gain complete visibility across code to cloud" },
                  { icon: Target, text: "Prioritize risks with contextual intelligence" },
                  { icon: Zap, text: "Remediate faster with automated workflows" },
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              <div className="relative w-full aspect-square">
                ...
                {/* Orbiting elements */}
                {[
                  { icon: Code, angle: 0, label: "Code" },
                  { icon: Layers, angle: 90, label: "Build" },
                  { icon: GitBranch, angle: 180, label: "Deploy" },
                  { icon: Activity, angle: 270, label: "Runtime" },
                ].map((item, i) => {
            ...
            {[
              {
                ...
                description:
                  "Automatically identify security issues across your entire application portfolio",
              },
              {
                icon: TrendingUp,
                title: "Risk Prioritization",
                description: "Focus on what matters most with AI-powered contextual risk scoring",
              },
              {
                icon: Layers,
                title: "Code-to-Cloud Visibility",
                description: "Track security posture from source code to production environments",
              },
              {
                icon: RefreshCw,
                title: "Continuous Posture Monitoring",
                description: "Real-time tracking of security changes and drift detection",
              },
            ].map((capability, i) => (
              <motion.div
                key={i}
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 md:gap-4 relative">
              {[
                ...
                { icon: Layers, label: "Correlate" },
                { icon: Target, label: "Prioritize" },
                { icon: Zap, label: "Remediate" },
                { icon: RefreshCw, label: "Monitor" },
              ].map((step, i) => (
                <motion.div
                  key={i}
      ...
      <section className="relative py-32 md:py-48 bg-gradient-to-b from-[#0D1B3E]/30 to-transparent">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 max-w-6xl mx-auto">
            {[
              {
                title: "Reduce Security Noise",
                text: "Stop drowning in alerts. ASPM consolidates findings from dozens of security tools into a single, prioritized view with intelligent deduplication and correlation.",
                highlight: "single, prioritized view",
              },
              {
                title: "Accelerate Remediation",
                text: "Empower developers with automated workflows and clear guidance. Reduce time-to-fix from weeks to hours with contextual insights and suggested remediation paths.",
                highlight: "weeks to hours",
              },
              {
                title: "Shift Left, Scale Right",
                text: "Integrate security early in the development process while maintaining visibility across all production environments. Scale security practices without slowing down delivery.",
                highlight: "without slowing down delivery",
              },
              {
                title: "Prove Compliance Continuously",
                text: "Demonstrate compliance posture in real-time with automated evidence collection and always-on audit trails. No more scrambling during audit season.",
                highlight: "real-time",
              },
            ].map((item, i) => (
              <motion.div
      ...
      <section className="relative py-32 md:py-48">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12">
          ...
          <div className="relative h-96 md:h-[500px]">
            {[
              { name: "GitHub", icon: GitBranch, position: { top: "10%", left: "15%" } },
              { name: "SAST", icon: Code, position: { top: "20%", left: "70%" } },
              { name: "SCA", icon: Layers, position: { top: "45%", left: "10%" } },
              { name: "DAST", icon: Search, position: { top: "50%", left: "50%" } },
              { name: "Container", icon: Lock, position: { top: "35%", left: "80%" } },
              { name: "Cloud", icon: Shield, position: { top: "70%", left: "25%" } },
              { name: "SIEM", icon: Activity, position: { top: "75%", left: "65%" } },
            ].map((integration, i) => (
              <motion.div
                key={i}
                className="absolute"
      ...
      <ServicePricing
        title={servicePlans["aspm"].title}
        description={servicePlans["aspm"].description}
        plans={servicePlans["aspm"].plans}
      />
      ...
      <section className="relative py-40 md:py-56 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 sm:px-8 md:px-12 max-w-5xl mx-auto">
          ...
          >
            Start protecting your applications with intelligent security posture management today
          </motion.p>
