...
export function WebDevelopmentPage({ onContactClick }: WebDevelopmentPageProps) {
  ...
  const processSteps = {
    ...
    4: {
      title: "Launch",
      description:
        "We handle deployment to production environments, configure monitoring systems, and ensure everything runs smoothly. Our team performs final testing, trains your staff, and provides comprehensive documentation for your application.",
      team: [
        "DevOps Engineer",
            ...
            <div>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 ${selectedStep === 1
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 ${selectedStep === 2
                      ? "bg-[#E8F4FF] dark:bg-[#0A1929]"
                      : "hover:bg-gray-50 dark:hover:bg-[#0A1929]"
                    }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 ${selectedStep === 3
                      ? "bg-[#E8F4FF] dark:bg-[#0A1929]"
                      : "hover:bg-gray-50 dark:hover:bg-[#0A1929]"
                    }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 ${selectedStep === 4
                      ? "bg-[#E8F4FF] dark:bg-[#0A1929]"
                      : "hover:bg-gray-50 dark:hover:bg-[#0A1929]"
                    }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl transition-all duration-300 ${selectedStep === 5
                      ? "bg-[#E8F4FF] dark:bg-[#0A1929]"
                      : "hover:bg-gray-50 dark:hover:bg-[#0A1929]"
                    }`}
                >
          ...
          <div className="bg-gradient-to-r from-[#0047AB] via-[#0066FF] to-[#00BFFF] rounded-3xl p-8 md:p-12 lg:p-16">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="flex justify-end">
                <a
                  href="https://wa.me/213668959953?text=I%20want%20to%20know%20how%20much%20it%20would%20cost%20to%20program%20a%20complete%20website"
                  target="_blank"
